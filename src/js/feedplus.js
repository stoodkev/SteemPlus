  ...
  $.ajax({
    ...
    success: function(result) {
      Object.keys(result.data).map(function(objectKey, index) {
        var userScoreList = [];
        userScoreList.push({name:'Human', value:(parseFloat(result.data[objectKey].classification_human_score)*100).toFixed(2)});
        userScoreList.push({name:'Bot', value:(parseFloat(result.data[objectKey].classification_bot_score)*100).toFixed(2)});
        userScoreList.push({name:'Spammer', value:(parseFloat(result.data[objectKey].classification_spammer_score)*100).toFixed(2)});
