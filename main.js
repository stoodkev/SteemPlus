...
function checkSMI(smi_installed_remind_me, smi_installed_remind_me_time){
  console.log(smi_installed_remind_me);
  console.log(smi_installed_remind_me_time);  
